    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Edit Course Assignment</h4>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form method="POST" action="{{ route('assign.course.edit', $editData[0]->class_id) }}">
                        @csrf
                        <div class="card-body">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <select name="course_id[]" required="" class="form-control">
                                                    ...
                                                    @foreach ($classes as $class)
                                                    <option value="{{ $class->id }}" {{ ($edit->course_id == $course->id) ? "selected" : "" }}>{{ $course->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
